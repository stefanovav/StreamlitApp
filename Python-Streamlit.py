...
rhino_compute_url = "https://savannah-done-newsletters-accordance.trycloudflare.com/io"
...
def run_grasshopper(area, thickness, project_url, speckle_token, selected_model_id):
    ...
    response = requests.post("https://savannah-done-newsletters-accordance.trycloudflare.com/grasshopper", headers=headers, json=request_data)
